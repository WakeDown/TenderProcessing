...
namespace ServiceClaim.Helpers
{
    public class MessageHelper
    {
        ...
        public static async Task SendMailSmtp(string subject, string body, bool isBodyHtml, string mailTo, string hiddenMailTo = null,
            ...
            string mailFrom = null, AttachmentFile file = null, bool isTest = false)
        {
            ...
            Task.Run(() => { SendMailSmtp(subject, body, isBodyHtml, recipients.ToArray(), recHidden.ToArray(), new MailAddress(mailFrom), file, isTest: isTest); });     
        ...
        public static  void SendMailSmtp(string subject, string body, bool isBodyHtml, MailAddress[] mailTo, MailAddress[] hiddenMailTo = null, MailAddress mailFrom = null, AttachmentFile file = null, bool isTest = false)
        {
            ...
            {
                string[] testMails = ConfigurationManager.AppSettings["FakeMailTo"]?.Split('|');
