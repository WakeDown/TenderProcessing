        ...
        public ActionResult GetSpecificationFileOnlyCalculation(int claimId)
        {
            ...
            try
            {
                ...
                if (positions.Any())
                {
                    ...
                    foreach (var position in positions)
                    {
                        if (position.Calculations != null && position.Calculations.Any())
                        {
                            foreach (var calculation in position.Calculations)
                            {
                                ...
                                workSheet.Cell(row, 2).Value = String.IsNullOrEmpty(calculation.CatalogNumber)
                                ...
                                workSheet.Cell(row, 3).Value = String.IsNullOrEmpty(calculation.Name)
                                    ? position.Name
                                    : calculation.Name;
                                workSheet.Cell(row, 3).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                                ...
                                workSheet.Cell(row, 5).Value = GetUnitStr(position.Unit);
                                workSheet.Cell(row, 5).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                                var countCell = workSheet.Cell(row, 6);
                                ...
                                if (position.ProductManager != null)
                                {
                                    ...
                                    workSheet.Cell(row, 7).Value = prodManager == null
                                        ? String.Empty
                                ...
                                priceEurRicohCell.Style.NumberFormat.Format = "€ #,###";
                                var priceRublCell = workSheet.Cell(row, 12);
                                ...
                                // />Вход за ед
                                priceRublCell.Style.NumberFormat.Format = "₽ #,###";
                                //Сумма
                                var priceSumCell = workSheet.Cell(row, 13);
                                priceSumCell.Style.NumberFormat.Format = "₽ #,###";
                                ...
                                //Цена с ТЗР
                                var priceTzrCell = workSheet.Cell(row, 14);
                                ...
                                sumTzrCell.Style.NumberFormat.Format = "₽ #,###";
                                ...
                                workSheet.Cell(row, 18).Value = calculation.Provider;
                        ...
                        else
                        {
                            workSheet.Cell(row, 1).Value = rowNumber;
                            workSheet.Cell(row, 1).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                            workSheet.Cell(row, 2).Value = position.CatalogNumber;
                            workSheet.Cell(row, 2).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                            workSheet.Cell(row, 3).Value = position.Name;
                            workSheet.Cell(row, 3).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                            workSheet.Cell(row, 4).Value = String.Empty;
                            workSheet.Cell(row, 4).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Left);
                            workSheet.Cell(row, 5).Value = GetUnitStr(position.Unit);
                            workSheet.Cell(row, 5).Style.Alignment.SetHorizontal(XLAlignmentHorizontalValues.Center);
                            workSheet.Cell(row, 6).Value = position.Value;
                            ...
                            workSheet.Cell(row, 12).Style.NumberFormat.Format = "₽ #,###";
                            workSheet.Cell(row, 18).Value = String.Empty;
                    ...
                    var range = workSheet.Range(workSheet.Cell(14, 1), workSheet.Cell(row - 1, 18));
